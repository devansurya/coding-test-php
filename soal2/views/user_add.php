        ...
        <form method="post" action="index.php?action=user_add">
            ...
            <div class="form-group">
                ...
                <input type="text" id="username" name="username" value="<?= $e($username) ?>"
                       required maxlength="128" autocomplete="off">
            </div>
            ...
            <div class="form-group">
                ...
                <div style="flex: 1;">
                    <input type="password" id="password" name="password"
                           required minlength="5" maxlength="8" autocomplete="new-password">
                    <div class="hint">Minimal 5 karakter, maksimal 8 karakter</div>
                </div>
            </div>
